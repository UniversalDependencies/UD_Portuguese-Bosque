...
in this project, with the prefix [bosque-ud-7.5]; they have been
either fixed at the source (PALAVRAS and/or UD conversion), workarounds
have been provided by the script "fix-errors.sh". 
